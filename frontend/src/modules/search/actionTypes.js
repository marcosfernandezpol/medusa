...
export const SEARCH_BOUGHT_COMPLETED = "project/search/searchBoughtCompleted";

export const CLEAR_NOT_BOUGHT = "project/search/clearNotBoughtOrders";
export const SEARCH_NOT_BOUGHT_COMPLETED = "project/search/searchNotBoughtCompleted";

export const CLEAR_SOLD = "project/search/clearSoldOrders";
export const SEARCH_SOLD_COMPLETED = "project/search/searchSoldCompleted";
